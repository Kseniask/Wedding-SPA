    ...
    <StMapSectionWrapper >
        <StSectionPart> 
            <StDiv textAlign="center" margin="10% 0">
                ...
                <StText fontSize="14px" onClick={() => window.open(ceremonyLocationLink, '_blank')} isLink>Rose Garden, Queen’s Park, New Westminster</StText>
                <StImage src={Line} width="50%" height="3px" opacity="20%"/>
                 <StText fontSize="18px">Celebration</StText>
                <StText fontSize="16px">16:00</StText>
                <StText fontSize="14px" onClick={() => window.open(celebrationLocationLink, '_blank')} isLink>Centennial Lodge, Queen’s Park, New Westminster</StText>
            </StDiv>
        </StSectionPart>
